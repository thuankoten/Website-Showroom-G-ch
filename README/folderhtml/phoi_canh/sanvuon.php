...
<head>
    ...
    <title>Phối cảnh sân vườn</title>
    ...
    <div id="container">
        ...
        <div class="phoicanh-detail-page">
            ...
            <div class="page-header">
                <h1>Phối cảnh sân vườn</h1>
                <p>Khám phá những mẫu gạch lát nền đẹp cho sân vườn</p>
            </div>

            <div class="phoicanh-gallery" id="phoicanh-gallery">
                <?php
                // Lấy tất cả dữ liệu phối cảnh từ database cho sân vườn
                ...
                if (mysqli_num_rows($result) > 0) {
                    while ($row = mysqli_fetch_assoc($result)) {
                        ...
                        echo '<div class="info">';
                        echo '<h4>Phối cảnh sân vườn ' . $row['id_phoicanh'] . '</h4>';
                        echo '<p>' . $row['mota'] . '</p>';
                        echo '</div>';
                        echo '</div>';
                    }
