...
<head>
    ...
    <title>Phối cảnh phòng vệ sinh</title>
    ...
    <div id="container">
        ...
        <div class="phoicanh-detail-page">
            ...
            <div class="page-header">
                <h1>Phối cảnh phòng vệ sinh</h1>
                <p>Khám phá những mẫu gạch lát nền đẹp cho phòng vệ sinh</p>
            </div>
            ...
            <div class="phoicanh-gallery" id="phoicanh-gallery">
                ...
                if (mysqli_num_rows($result) > 0) {
                    while ($row = mysqli_fetch_assoc($result)) {
                        ...
                        echo '<div class="info">';
                        echo '<h4>Phối cảnh phòng vệ sinh ' . $row['id_phoicanh'] . '</h4>';
                        echo '<p>' . $row['mota'] . '</p>';
                        echo '</div>';
                        echo '</div>';
                    }
