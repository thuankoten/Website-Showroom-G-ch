...
<head>
    ...
    <title>Phối cảnh phòng bếp</title>
    ...
    <div id="container">
        ...
        <div class="phoicanh-detail-page">
            ...
            <div class="page-header">
                <h1>Phối cảnh phòng bếp</h1>
                <p>Khám phá những mẫu gạch lát nền đẹp cho phòng bếp</p>
            </div>

            <div class="phoicanh-gallery" id="phoicanh-gallery">
                <?php
                // Lấy dữ liệu phối cảnh từ database (ID 5-8 cho phòng bếp)
                ...
                if (mysqli_num_rows($result) > 0) {
                    while ($row = mysqli_fetch_assoc($result)) {
                        ...
                        echo '<div class="info">';
                        echo '<h4>Phối cảnh phòng bếp ' . $row['id_phoicanh'] . '</h4>';
                        echo '<p>' . $row['mota'] . '</p>';
                        echo '</div>';
                        echo '</div>';
                    }
